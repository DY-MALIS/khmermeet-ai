...
function transcriptionChatPrompt(language: "km" | "en" | "km-en", speakerNames: string[] = [], singleSpeaker = false) {
  ...
  return [
    ...
    "Listen for clearly audible words and speaker changes before writing. Do not reconstruct faint syllables from context or repeat a phrase just to fill a quiet span.",
    "Include greetings, filler words, repeated words, side comments, short acknowledgements, incomplete phrases, and quiet replies only when you can actually hear them.",
    ...
    "Capture audible speakers and words without merging different people's speech. Include short interjections only when audible.",
    ...
    "Check near and distant voices, but never turn room noise or an indistinct voice into plausible words.",
    ...
    "For quiet or distant speech, transcribe only words you can actually understand. For noisy, overlapped, muted, or unintelligible speech, write [unclear] instead of producing a fluent guess. Do not add any text for silence or non-speech sounds.",
