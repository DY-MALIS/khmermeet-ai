        ...
        <main style={{ display: "grid", minHeight: "100vh", placeItems: "center", padding: 24, fontFamily: "system-ui, sans-serif" }}>
          <section style={{ maxWidth: 560, border: "1px solid #e2e8f0", borderRadius: 12, padding: 24, textAlign: "center" }}>
            ...
            <p style={{ color: "#475569", lineHeight: 1.7 }}>
              សូមចុច Try again។ ប្រសិនបើនៅតែមានបញ្ហា សូមពិនិត្យ Runtime Logs នៅ Vercel។
            </p>
            {error.digest ? <p style={{ color: "#94a3b8", fontSize: 12 }}>Digest: {error.digest}</p> : null}
            <button
              type="button"
              onClick={reset}
              style={{ border: 0, borderRadius: 10, background: "#18745f", color: "white", cursor: "pointer", fontWeight: 700, padding: "10px 16px" }}
            >
              Try again
            </button>
          </section>
