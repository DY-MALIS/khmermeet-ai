    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.15fr_.85fr]">
        ...
        <section className="kh-card p-5">
          ...
          {meeting.summary ? <div className="whitespace-pre-wrap text-sm leading-7 text-slate-700">{meeting.summary}</div> : <EmptyState title="មិនទាន់មាន summary" description="បញ្ចូល transcript រួចចុច Generate AI Summary។" />}
        </section>
      </div>
